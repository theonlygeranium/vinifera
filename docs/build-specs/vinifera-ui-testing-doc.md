...
**Baseline:** v0.5.0 — BS-01 through BS-06 merged, 577 Vitest + 155 passed Playwright/axe with 3 hosted-only skips
...
- `npm run check` must pass before every push (577 Vitest + TypeScript clean + zero axe violations).
...
npm run check           # TypeScript + 577 Vitest must pass
...
#
#    Verification: npm run check; 577/577 Vitest; 155 passed Playwright/axe
...
| Criterion | Target |
|-----------|--------|
| Vitest suite | 577/577 passing (must not decrease) |

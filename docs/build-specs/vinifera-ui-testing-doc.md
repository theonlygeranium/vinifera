...
**Baseline:** v0.5.0 — BS-01 through BS-06 merged, 549 Vitest + 155 passed Playwright/axe with 3 hosted-only skips
...
- `npm run check` must pass before every push (549 Vitest + TypeScript clean + zero axe violations).
...
npm run check           # TypeScript + 549 Vitest must pass
...
#
#    Verification: npm run check; 549/549 Vitest; 155 passed Playwright/axe
...
| Criterion | Target |
|-----------|--------|
| Vitest suite | 549/549 passing (must not decrease) |

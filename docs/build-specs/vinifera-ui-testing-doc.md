...
**Baseline:** v0.5.0 — BS-01 through BS-06 merged, 587 Vitest + 155 passed Playwright/axe with 3 hosted-only skips
...
- `npm run check` must pass before every push (587 Vitest + TypeScript clean + zero axe violations).
...
npm run check           # TypeScript + 587 Vitest must pass
...
#
#    Verification: npm run check; 587/587 Vitest; 155 passed Playwright/axe
...
| Criterion | Target |
|-----------|--------|
| Vitest suite | 587/587 passing (must not decrease) |

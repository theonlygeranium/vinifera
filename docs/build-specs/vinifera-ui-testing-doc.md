...
**Baseline:** v0.5.0 — BS-01 through BS-06 merged, 595 Vitest + 155 passed Playwright/axe with 3 hosted-only skips
...
- `npm run check` must pass before every push (595 Vitest + TypeScript clean + zero axe violations).
...
npm run check           # TypeScript + 595 Vitest must pass

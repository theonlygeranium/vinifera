...
**Baseline:** v0.5.0 — BS-01 through BS-06 merged, 569 Vitest + 155 passed Playwright/axe with 3 hosted-only skips
...
- `npm run check` must pass before every push (569 Vitest + TypeScript clean + zero axe violations).
...
npm run check           # TypeScript + 569 Vitest must pass
...
#
#    Verification: npm run check; 569/569 Vitest; 155 passed Playwright/axe
...
| Criterion | Target |
|-----------|--------|
| Vitest suite | 569/569 passing (must not decrease) |

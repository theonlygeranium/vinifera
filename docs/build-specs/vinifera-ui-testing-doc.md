...
**Baseline:** v0.5.0 — BS-01 through BS-06 merged, 550 Vitest + 155 passed Playwright/axe with 3 hosted-only skips
...
- `npm run check` must pass before every push (550 Vitest + TypeScript clean + zero axe violations).
...
npm run check           # TypeScript + 550 Vitest must pass
...
#
#    Verification: npm run check; 550/550 Vitest; 155 passed Playwright/axe
...
| Criterion | Target |
|-----------|--------|
| Vitest suite | 550/550 passing (must not decrease) |

...
|    8 | Activate Resend                                               | pending — acceptance controller source-complete | Successful reviewed staging run proving the exact verified domain and signed webhook plus real hourly-Cron delivery/reconciliation for welcome and pre-shipment; provider/DNS provisioning remains prerequisite                                                                                                            | Track A — communications     |

...
function qboConfiguration(env: WorkerEnv): QuickBooksOAuthConfiguration {
...
interface ClaimedIntegrationJob {
...
function integrationAdmin(env: WorkerEnv): SupabaseClient {
  return createClient(
...
async function executeKlaviyoEngagement(
  env: WorkerEnv,
  admin: SupabaseClient,
  job: ClaimedIntegrationJob,
): Promise<IntegrationJobCompletion> {

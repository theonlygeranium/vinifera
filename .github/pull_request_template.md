...
- [ ] Required checks and reviews pass: `Type, test, build, and package`, Octopus, and CodeRabbit
- [ ] Branch is current with its target base (`dev` for agent-authored PRs)
...
- [ ] Actionable findings were fixed, affected tests were rerun, and fresh Octopus/CodeRabbit/CI results passed
